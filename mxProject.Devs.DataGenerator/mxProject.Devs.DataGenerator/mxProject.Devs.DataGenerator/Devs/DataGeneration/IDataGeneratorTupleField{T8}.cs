...
namespace mxProject.Devs.DataGeneration
{
    ...
    public interface IDataGeneratorTupleField<T1, T2, T3, T4, T5, T6, T7, T8> : IDataGeneratorTupleField
        where T1 : struct
        where T2 : struct
        where T3 : struct
        where T4 : struct
        ...
        where T8 : struct
    {
        ...
        /// <returns></returns>
        ValueTask<IDataGeneratorTupleFieldEnumeration<T1, T2, T3, T4, T5, T6, T7, T8>> CreateTypedEnumerationAsync(int generationCount);
