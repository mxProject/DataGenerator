...
namespace mxProject.Devs.DataGeneration.ModelMappings.Fields
{
    ...
    public class AnyEnumFieldAttribute : AnyFieldAttribute
    {
        ...
        public AnyEnumFieldAttribute(Type enumType, double nullProbability = 0, string? fieldName = null)
        ...
        /// <param name="nullProbability">Probability of returning null. (between 0 and 1.0)</param>
        /// <param name="fieldName">The field name.</param>
        public AnyEnumFieldAttribute(Type enumType, string?[] values, double nullProbability = 0, string? fieldName = null)
