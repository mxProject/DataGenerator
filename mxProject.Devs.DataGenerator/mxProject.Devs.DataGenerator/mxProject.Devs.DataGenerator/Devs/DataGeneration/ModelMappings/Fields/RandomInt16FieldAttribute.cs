...
namespace mxProject.Devs.DataGeneration.ModelMappings.Fields
{
    ...
    public class RandomInt16FieldAttribute : RandomFieldAttribute
    {
        ...
        public RandomInt16FieldAttribute(short minValue = short.MinValue, short maxValue = short.MaxValue, double nullProbability = 0, Type? selectorDecralingType = null, string? selectorMethodName = null, string? fieldName = null)
        ...
        {
            var selector = GetSelectorMethod<Func<short, short>>(SelectorDecralingType, SelectorMethodName);
            return context.FieldFactory.RandomInt16(FieldName ?? member.Name, MinimumValue, MaximumValue, selector, NullProbability);
        }
