...
namespace mxProject.Devs.DataGeneration.ModelMappings.Fields
{
    ...
    public class SequenceUInt64FieldAttribute : SequenceFieldAttribute
    {
        ...
        public SequenceUInt64FieldAttribute(ulong initialValue = 1, ulong maxValue = ulong.MaxValue, ulong increment = 1, double nullProbability = 0, string? fieldName = null)
        ...
        {
            return context.FieldFactory.SequenceUInt64(FieldName ?? member.Name, InitialValue, MaximumValue, Increment, NullProbability);
        }
