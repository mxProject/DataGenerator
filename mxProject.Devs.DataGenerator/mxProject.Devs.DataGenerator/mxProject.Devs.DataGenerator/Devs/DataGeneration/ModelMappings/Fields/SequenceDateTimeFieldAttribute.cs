...
namespace mxProject.Devs.DataGeneration.ModelMappings.Fields
{
    ...
    public class SequenceDateTimeFieldAttribute : SequenceFieldAttribute
    {
        ...
        public SequenceDateTimeFieldAttribute(string initialValue, string maxValue, string increment, double nullProbability = 0, string? fieldName = null)
        ...
        public override IDataGeneratorField CreateField(MemberInfo member, DataGeneratorContext context)
        {
            ...
            return context.FieldFactory.SequenceDateTime(FieldName ?? member.Name, initial, maxValue, increment, NullProbability);
        }
