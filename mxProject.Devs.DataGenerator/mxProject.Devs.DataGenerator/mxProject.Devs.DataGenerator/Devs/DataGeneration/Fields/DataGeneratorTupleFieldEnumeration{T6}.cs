...
namespace mxProject.Devs.DataGeneration.Fields
{
    ...
    public class DataGeneratorTupleFieldEnumeration<T1, T2, T3, T4, T5, T6> : DataGeneratorTupleFieldEnumerationBase<(T1?, T2?, T3?, T4?, T5?, T6?)>, IDataGeneratorTupleFieldEnumeration<T1, T2, T3, T4, T5, T6>
        where T1 : struct
        where T2 : struct
        where T3 : struct
        where T4 : struct
        ...
        where T6 : struct
    {
        ...
        public DataGeneratorTupleFieldEnumeration(string fieldName1, string fieldName2, string fieldName3, string fieldName4, string fieldName5, string fieldName6, IEnumerable<(T1?, T2?, T3?, T4?, T5?, T6?)> enumeration)
            : base(new[] { fieldName1, fieldName2, fieldName3, fieldName4, fieldName5, fieldName6 }, new[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6) }, enumeration)
        {
        }
