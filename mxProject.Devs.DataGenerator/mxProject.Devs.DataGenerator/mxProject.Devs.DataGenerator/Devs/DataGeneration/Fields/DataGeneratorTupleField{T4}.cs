...
namespace mxProject.Devs.DataGeneration.Fields
{
        ...
        where T4 : struct
    {
        ...
        public DataGeneratorTupleField(string fieldName1, bool mayBeNull1, string fieldName2, bool mayBeNull2, string fieldName3, bool mayBeNull3, string fieldName4, bool mayBeNull4, TupleEnumerationCreatorAsync<T1, T2, T3, T4> enumerationCreator)
        ...
        private readonly TupleEnumerationCreatorAsync<T1, T2, T3, T4> m_EnumerationCreator;
