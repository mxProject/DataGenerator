...
namespace mxProject.Devs.DataGeneration.Fields
{
    ...
    public class DataGeneratorTupleFieldEnumeration<T1, T2, T3, T4, T5, T6, T7, T8, T9> : DataGeneratorTupleFieldEnumerationBase<(T1?, T2?, T3?, T4?, T5?, T6?, T7?, T8?, T9?)>, IDataGeneratorTupleFieldEnumeration<T1, T2, T3, T4, T5, T6, T7, T8, T9>
        where T1 : struct
        where T2 : struct
        where T3 : struct
        where T4 : struct
        ...
        where T9 : struct
    {
        ...
        public DataGeneratorTupleFieldEnumeration(string fieldName1, string fieldName2, string fieldName3, string fieldName4, string fieldName5, string fieldName6, string fieldName7, string fieldName8, string fieldName9, IEnumerable<(T1?, T2?, T3?, T4?, T5?, T6?, T7?, T8?, T9?)> enumeration)
            : base(new[] { fieldName1, fieldName2, fieldName3, fieldName4, fieldName5, fieldName6, fieldName7, fieldName8, fieldName9 }, new[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7), typeof(T8), typeof(T9) }, enumeration)
        {
        }
