...
namespace mxProject.Devs.DataGeneration.Fields
{
    ...
    public class DataGeneratorTupleField<T1, T2, T3, T4, T5, T6, T7, T8> : DataGeneratorTupleFieldBase, IDataGeneratorTupleField<T1, T2, T3, T4, T5, T6, T7, T8>
        where T1 : struct
        where T2 : struct
        where T3 : struct
        where T4 : struct
        ...
        where T8 : struct
    {
        ...
        public DataGeneratorTupleField(string fieldName1, bool mayBeNull1, string fieldName2, bool mayBeNull2, string fieldName3, bool mayBeNull3, string fieldName4, bool mayBeNull4, string fieldName5, bool mayBeNull5, string fieldName6, bool mayBeNull6, string fieldName7, bool mayBeNull7, string fieldName8, bool mayBeNull8, TupleEnumerationCreatorAsync<T1, T2, T3, T4, T5, T6, T7, T8> enumerationCreator)
            : base(new[] { fieldName1, fieldName2, fieldName3, fieldName4, fieldName5, fieldName6, fieldName7, fieldName8 }, new[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7), typeof(T8) }, new[] { mayBeNull1, mayBeNull2, mayBeNull3, mayBeNull4, mayBeNull4, mayBeNull5, mayBeNull6, mayBeNull7, mayBeNull8 })
        {
            m_EnumerationCreator = enumerationCreator;
        }

        private readonly TupleEnumerationCreatorAsync<T1, T2, T3, T4, T5, T6, T7, T8> m_EnumerationCreator;
        ...
        /// <inheritdoc/>
        public async ValueTask<IDataGeneratorTupleFieldEnumeration<T1, T2, T3, T4, T5, T6, T7, T8>> CreateTypedEnumerationAsync(int generateCount)
        {
            return new DataGeneratorTupleFieldEnumeration<T1, T2, T3, T4, T5, T6, T7, T8>(GetFieldName(0), GetFieldName(1), GetFieldName(2), GetFieldName(3), GetFieldName(4), GetFieldName(5), GetFieldName(6), GetFieldName(7)
