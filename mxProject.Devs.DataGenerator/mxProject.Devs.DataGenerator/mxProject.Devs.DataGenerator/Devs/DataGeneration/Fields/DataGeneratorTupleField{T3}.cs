...
namespace mxProject.Devs.DataGeneration.Fields
{
    ...
    public class DataGeneratorTupleField<T1, T2, T3> : DataGeneratorTupleFieldBase, IDataGeneratorTupleField<T1, T2, T3>
        where T1 : struct
        where T2 : struct
        where T3 : struct
    {
        ...
        /// <inheritdoc/>
        public async ValueTask<IDataGeneratorTupleFieldEnumeration<T1, T2, T3>> CreateTypedEnumerationAsync(int generateCount)
        {
            return new DataGeneratorTupleFieldEnumeration<T1, T2, T3>(GetFieldName(0), GetFieldName(1), GetFieldName(2)
