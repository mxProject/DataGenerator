...
namespace mxProject.Devs.DataGeneration
{
    ...
    public interface IDataGeneratorTupleField<T1, T2> : IDataGeneratorTupleField
        where T1 : struct
        where T2 : struct
    {
        ...
        /// <returns></returns>
        ValueTask<IDataGeneratorTupleFieldEnumeration<T1, T2>> CreateTypedEnumerationAsync(int generationCount);
