...
namespace mxProject.Devs.DataGeneration
{
    ...
    public interface IDataGeneratorTupleField<T1, T2, T3, T4, T5, T6> : IDataGeneratorTupleField
        where T1 : struct
        where T2 : struct
        where T3 : struct
        where T4 : struct
        ...
        where T6 : struct
    {
        ...
        /// <returns></returns>
        ValueTask<IDataGeneratorTupleFieldEnumeration<T1, T2, T3, T4, T5, T6>> CreateTypedEnumerationAsync(int generationCount);
