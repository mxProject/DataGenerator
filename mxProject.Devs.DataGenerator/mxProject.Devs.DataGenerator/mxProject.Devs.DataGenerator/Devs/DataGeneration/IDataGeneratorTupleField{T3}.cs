...
namespace mxProject.Devs.DataGeneration
{
    ...
    public interface IDataGeneratorTupleField<T1, T2, T3> : IDataGeneratorTupleField
        where T1 : struct
        where T2 : struct
        where T3 : struct
    {
        ...
        /// <returns></returns>
        ValueTask<IDataGeneratorTupleFieldEnumeration<T1, T2, T3>> CreateTypedEnumerationAsync(int generationCount);
