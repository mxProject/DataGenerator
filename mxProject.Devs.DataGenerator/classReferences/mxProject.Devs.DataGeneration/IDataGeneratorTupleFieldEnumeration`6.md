...
# IDataGeneratorTupleFieldEnumeration&lt;T1, T2, T3, T4, T5, T6&gt; Interface
...
|:--|:--|:--|:--|
| public | [GetTypedValues](#gettypedvalues-method) | (T1?, T2?, T3?, T4?, T5?, T6?) | Gets the generated values. |
---
### GetTypedValues Method

Gets the generated values.
```c#
(T1?, T2?, T3?, T4?, T5?, T6?) GetTypedValues()
```
#### Return type
