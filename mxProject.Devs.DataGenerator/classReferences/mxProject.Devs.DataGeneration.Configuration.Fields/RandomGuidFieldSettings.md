...
# RandomGuidFieldSettings Class



Settings for a field that enumerates the random System.Guid values.
...
```c#
public RandomGuidFieldSettings()
```
...
| public | [NullProbability](#nullprobability-property) | double | Inherited from  mxProject.Devs.DataGeneration.Configuration.Fields.RandomFieldSettingsBase{System.Guid} . |
---
### FieldName Property
...
Inherited from  mxProject.Devs.DataGeneration.Configuration.Fields.RandomFieldSettingsBase{System.Guid} .
```c#
...
Creates an instance of [IDataGeneratorField](../mxProject.Devs.DataGeneration/IDataGeneratorField.md) interface.Inherited from  [RandomGuidFieldSettings](../mxProject.Devs.DataGeneration.Configuration.Fields/RandomGuidFieldSettings.md) .
```c#
