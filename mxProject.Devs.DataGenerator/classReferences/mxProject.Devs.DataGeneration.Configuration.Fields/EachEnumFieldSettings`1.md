...
# EachEnumFieldSettings&lt;TEnum&gt; Class
...
|:--|:--|:--|
| TEnum | The type of value to enumerate. | struct, Enum |

## Inheritance tree
* mxProject.Devs.DataGeneration.Configuration.Fields.EachFieldSettingsBase&lt;TEnum&gt;
...
| public | [NullProbability](#nullprobability-property) | double | Inherited from  mxProject.Devs.DataGeneration.Configuration.Fields.EachFieldSettingsBase{`0} . |
| public | [Values](#values-property) | TEnum[] | Inherited from  mxProject.Devs.DataGeneration.Configuration.Fields.EachFieldSettingsBase{`0} . |
---
### FieldName Property
...
Inherited from  mxProject.Devs.DataGeneration.Configuration.Fields.EachFieldSettingsBase{`0} .
```c#
...
|:--|:--|:--|:--|
| protected | [Assert](#assert-method) | void | Inherited from  mxProject.Devs.DataGeneration.Configuration.Fields.EachFieldSettingsBase{`0} . |
| public | [Clone](#clone-method) | object | Inherited from  mxProject.Devs.DataGeneration.Configuration.Fields.EachFieldSettingsBase{`0} . |
...
Creates an instance of [IDataGeneratorField](../mxProject.Devs.DataGeneration/IDataGeneratorField.md) interface.Inherited from  [EachEnumFieldSettings&lt;TEnum&gt;](../mxProject.Devs.DataGeneration.Configuration.Fields/EachEnumFieldSettings`1.md) .
```c#
