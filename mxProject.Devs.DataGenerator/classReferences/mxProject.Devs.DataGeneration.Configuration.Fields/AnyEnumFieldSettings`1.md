...
# AnyEnumFieldSettings&lt;TEnum&gt; Class
...
| public | [NullProbability](#nullprobability-property) | double | Inherited from  mxProject.Devs.DataGeneration.Configuration.Fields.AnyFieldSettingsBase{`0} . |
| public | [Values](#values-property) | TEnum[] | Inherited from  mxProject.Devs.DataGeneration.Configuration.Fields.AnyFieldSettingsBase{`0} . |
---
### FieldName Property
...
| protected | [GetValuesCount](#getvaluescount-method) | int | Inherited from  mxProject.Devs.DataGeneration.Configuration.Fields.AnyFieldSettingsBase{`0} . |
...
Creates an instance of [IDataGeneratorField](../mxProject.Devs.DataGeneration/IDataGeneratorField.md) interface.Inherited from  [AnyEnumFieldSettings&lt;TEnum&gt;](../mxProject.Devs.DataGeneration.Configuration.Fields/AnyEnumFieldSettings`1.md) .
```c#
