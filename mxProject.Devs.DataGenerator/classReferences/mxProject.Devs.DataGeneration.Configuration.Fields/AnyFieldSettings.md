...
|:--|:--|:--|:--|
| protected | [Assert](#assert-method) | void | If the settings for this instance are invalid, an exception will be thrown.Inherited from  [AnyFieldSettings](../mxProject.Devs.DataGeneration.Configuration.Fields/AnyFieldSettings.md) . |
...
If the settings for this instance are invalid, an exception will be thrown.Inherited from  [AnyFieldSettings](../mxProject.Devs.DataGeneration.Configuration.Fields/AnyFieldSettings.md) .
```c#
