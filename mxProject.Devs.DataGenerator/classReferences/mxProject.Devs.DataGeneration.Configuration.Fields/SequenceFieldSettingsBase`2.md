...
# SequenceFieldSettingsBase&lt;TValue, TIncrement&gt; Class
...
|:--|:--|:--|
| TValue | The type of value to enumerate. | struct |
| TIncrement | The type of increment value. | struct |
...
| public | [Increment](#increment-property) | TIncrement? | Gets or sets the amount of increase in value when creating a new sequence value. |
| public | [InitialValue](#initialvalue-property) | TValue | Gets or sets the initial value. |
...
|:--|:--|:--|:--|
| protected | [Assert](#assert-method) | void | If the settings for this instance are invalid, an exception will be thrown.Inherited from  [SequenceFieldSettingsBase&lt;TValue, TIncrement&gt;](../mxProject.Devs.DataGeneration.Configuration.Fields/SequenceFieldSettingsBase`2.md) . |
...
If the settings for this instance are invalid, an exception will be thrown.Inherited from  [SequenceFieldSettingsBase&lt;TValue, TIncrement&gt;](../mxProject.Devs.DataGeneration.Configuration.Fields/SequenceFieldSettingsBase`2.md) .
```c#
