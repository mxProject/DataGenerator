...
# RandomFieldSettingsBase&lt;TValue&gt; Class
...
|:--|:--|:--|:--|
| protected | [Assert](#assert-method) | void | If the settings for this instance are invalid, an exception will be thrown.Inherited from  [RandomFieldSettingsBase&lt;TValue&gt;](../mxProject.Devs.DataGeneration.Configuration.Fields/RandomFieldSettingsBase`1.md) . |
...
If the settings for this instance are invalid, an exception will be thrown.Inherited from  [RandomFieldSettingsBase&lt;TValue&gt;](../mxProject.Devs.DataGeneration.Configuration.Fields/RandomFieldSettingsBase`1.md) .
```c#
