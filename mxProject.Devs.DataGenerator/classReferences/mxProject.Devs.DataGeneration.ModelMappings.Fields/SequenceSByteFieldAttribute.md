...
# SequenceSByteFieldAttribute Class
...
|:--|:--|:--|
| public | [.ctor(sbyte, sbyte, sbyte, double, string)](#ctorsbyte-sbyte-sbyte-double-string-constructor) | Create a new instance. |
---
### .ctor(sbyte, sbyte, sbyte, double, string) Constructor

Create a new instance.
```c#
public SequenceSByteFieldAttribute(
	sbyte initialValue
	, sbyte maxValue
	, sbyte increment
...
| public | [Increment](#increment-property) | sbyte | Gets the amount of increase in value when creating a new sequence value. |
| public | [InitialValue](#initialvalue-property) | sbyte | Gets the initial value. |
| public | [MaximumValue](#maximumvalue-property) | sbyte | Gets the maximum value. |
...
Creates an instance of [IDataGeneratorField](../mxProject.Devs.DataGeneration/IDataGeneratorField.md) interface.Inherited from  [SequenceSByteFieldAttribute](../mxProject.Devs.DataGeneration.ModelMappings.Fields/SequenceSByteFieldAttribute.md) .
```c#
