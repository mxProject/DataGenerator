...
# SequenceDateTimeOffsetFieldAttribute Class
...
```c#
public SequenceDateTimeOffsetFieldAttribute(
	string initialValue
	, string maxValue
	, string increment
...
Creates an instance of [IDataGeneratorField](../mxProject.Devs.DataGeneration/IDataGeneratorField.md) interface.Inherited from  [SequenceDateTimeOffsetFieldAttribute](../mxProject.Devs.DataGeneration.ModelMappings.Fields/SequenceDateTimeOffsetFieldAttribute.md) .
```c#
