...
# RandomSByteFieldAttribute Class
...
|:--|:--|:--|
| public | [.ctor(sbyte, sbyte, double, Type, string, string)](#ctorsbyte-sbyte-double-type-string-string-constructor) | Create a new instance. |
---
### .ctor(sbyte, sbyte, double, Type, string, string) Constructor

Create a new instance.
```c#
public RandomSByteFieldAttribute(
	sbyte minValue
	, sbyte maxValue
...
| public | [MinimumValue](#minimumvalue-property) | sbyte | Gets the minimum value. |
...
Creates an instance of [IDataGeneratorField](../mxProject.Devs.DataGeneration/IDataGeneratorField.md) interface.Inherited from  [RandomSByteFieldAttribute](../mxProject.Devs.DataGeneration.ModelMappings.Fields/RandomSByteFieldAttribute.md) .
```c#
