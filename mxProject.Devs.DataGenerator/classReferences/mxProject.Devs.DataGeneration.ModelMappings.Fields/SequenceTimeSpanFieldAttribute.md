...
# SequenceTimeSpanFieldAttribute Class
...
```c#
public SequenceTimeSpanFieldAttribute(
	string initialValue
	, string maxValue
	, string increment
...
Creates an instance of [IDataGeneratorField](../mxProject.Devs.DataGeneration/IDataGeneratorField.md) interface.Inherited from  [SequenceTimeSpanFieldAttribute](../mxProject.Devs.DataGeneration.ModelMappings.Fields/SequenceTimeSpanFieldAttribute.md) .
```c#
