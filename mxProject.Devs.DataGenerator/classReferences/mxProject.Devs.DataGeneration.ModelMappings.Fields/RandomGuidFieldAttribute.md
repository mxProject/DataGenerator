...
# RandomGuidFieldAttribute Class
...
|:--|:--|:--|
| public | [.ctor(double, string)](#ctordouble-string-constructor) | Create a new instance. |
---
### .ctor(double, string) Constructor

Create a new instance.
```c#
public RandomGuidFieldAttribute(
...
Creates an instance of [IDataGeneratorField](../mxProject.Devs.DataGeneration/IDataGeneratorField.md) interface.Inherited from  [RandomGuidFieldAttribute](../mxProject.Devs.DataGeneration.ModelMappings.Fields/RandomGuidFieldAttribute.md) .
```c#
