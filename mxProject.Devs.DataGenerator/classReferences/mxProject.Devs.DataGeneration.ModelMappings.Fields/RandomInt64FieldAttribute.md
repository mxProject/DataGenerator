...
# RandomInt64FieldAttribute Class
...
|:--|:--|:--|
| public | [.ctor(long, long, double, string)](#ctorlong-long-double-string-constructor) | Create a new instance. |
---
### .ctor(long, long, double, string) Constructor

Create a new instance.
```c#
public RandomInt64FieldAttribute(
	long minValue
	, long maxValue
...
| public | [MinimumValue](#minimumvalue-property) | long | Gets the minimum value. |
...
Creates an instance of [IDataGeneratorField](../mxProject.Devs.DataGeneration/IDataGeneratorField.md) interface.Inherited from  [RandomInt64FieldAttribute](../mxProject.Devs.DataGeneration.ModelMappings.Fields/RandomInt64FieldAttribute.md) .
```c#
