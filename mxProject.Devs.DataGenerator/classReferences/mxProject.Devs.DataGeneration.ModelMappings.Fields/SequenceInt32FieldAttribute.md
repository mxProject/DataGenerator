...
# SequenceInt32FieldAttribute Class
...
|:--|:--|:--|
| public | [.ctor(int, int, int, double, string)](#ctorint-int-int-double-string-constructor) | Create a new instance. |
---
### .ctor(int, int, int, double, string) Constructor

Create a new instance.
```c#
public SequenceInt32FieldAttribute(
	int initialValue
	, int maxValue
	, int increment
...
| public | [Increment](#increment-property) | int | Gets the amount of increase in value when creating a new sequence value. |
| public | [InitialValue](#initialvalue-property) | int | Gets the initial value. |
...
Creates an instance of [IDataGeneratorField](../mxProject.Devs.DataGeneration/IDataGeneratorField.md) interface.Inherited from  [SequenceInt32FieldAttribute](../mxProject.Devs.DataGeneration.ModelMappings.Fields/SequenceInt32FieldAttribute.md) .
```c#
