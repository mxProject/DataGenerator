...
# RandomDecimalFieldAttribute Class
...
|:--|:--|:--|
| public | [.ctor(double, double, double, Type, string, string)](#ctordouble-double-double-type-string-string-constructor) | Create a new instance. |
---
### .ctor(double, double, double, Type, string, string) Constructor

Create a new instance.
```c#
public RandomDecimalFieldAttribute(
	double minValue
	, double maxValue
...
| public | [MaximumValue](#maximumvalue-property) | decimal | Gets the maximum value. |
| public | [MinimumValue](#minimumvalue-property) | decimal | Gets the minimum value. |
...
Creates an instance of [IDataGeneratorField](../mxProject.Devs.DataGeneration/IDataGeneratorField.md) interface.Inherited from  [RandomDecimalFieldAttribute](../mxProject.Devs.DataGeneration.ModelMappings.Fields/RandomDecimalFieldAttribute.md) .
```c#
