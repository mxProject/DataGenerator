...
# RandomDateTimeOffsetFieldAttribute Class
...
```c#
public RandomDateTimeOffsetFieldAttribute(
	string minValue
	, string maxValue
...
Creates an instance of [IDataGeneratorField](../mxProject.Devs.DataGeneration/IDataGeneratorField.md) interface.Inherited from  [RandomDateTimeOffsetFieldAttribute](../mxProject.Devs.DataGeneration.ModelMappings.Fields/RandomDateTimeOffsetFieldAttribute.md) .
```c#
