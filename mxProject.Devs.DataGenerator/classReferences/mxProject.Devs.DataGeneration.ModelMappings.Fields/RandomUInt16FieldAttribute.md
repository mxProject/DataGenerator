...
# RandomUInt16FieldAttribute Class
...
|:--|:--|:--|
| public | [.ctor(ushort, ushort, double, Type, string, string)](#ctorushort-ushort-double-type-string-string-constructor) | Create a new instance. |
---
### .ctor(ushort, ushort, double, Type, string, string) Constructor

Create a new instance.
```c#
public RandomUInt16FieldAttribute(
	ushort minValue
	, ushort maxValue
...
| public | [MinimumValue](#minimumvalue-property) | ushort | Gets the minimum value. |
...
Creates an instance of [IDataGeneratorField](../mxProject.Devs.DataGeneration/IDataGeneratorField.md) interface.Inherited from  [RandomUInt16FieldAttribute](../mxProject.Devs.DataGeneration.ModelMappings.Fields/RandomUInt16FieldAttribute.md) .
```c#
