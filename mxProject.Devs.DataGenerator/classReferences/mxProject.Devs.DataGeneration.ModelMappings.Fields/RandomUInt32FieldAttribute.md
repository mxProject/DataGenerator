...
# RandomUInt32FieldAttribute Class
...
|:--|:--|:--|
| public | [.ctor(uint, uint, double, string)](#ctoruint-uint-double-string-constructor) | Create a new instance. |
---
### .ctor(uint, uint, double, string) Constructor

Create a new instance.
```c#
public RandomUInt32FieldAttribute(
	uint minValue
	, uint maxValue
...
| public | [MinimumValue](#minimumvalue-property) | uint | Gets the minimum value. |
...
Creates an instance of [IDataGeneratorField](../mxProject.Devs.DataGeneration/IDataGeneratorField.md) interface.Inherited from  [RandomUInt32FieldAttribute](../mxProject.Devs.DataGeneration.ModelMappings.Fields/RandomUInt32FieldAttribute.md) .
```c#
