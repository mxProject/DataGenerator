...
namespace mxProject.Tools.DataFountain.Forms.FieldEditors.Fields
{
    ...
    /// <summary>
    /// Editor for <see cref="AnyFieldSettings"/>.
    /// </summary>
    internal partial class AnyFieldEditor : FieldEditorBase
    {
        ...
        internal AnyFieldEditor(DataFountainContext context) : base(context)
        {
            InitializeComponent();
        ...
        {
            foreach (var type in Context.GetSupportedValueTypes(DataGeneratorFieldType.Any))
            {
        ...
        private AnyFieldSettings? m_OriginalFieldSettings;
        ...
        protected override void SetFieldSettings(DataGeneratorFieldSettingsState? field)
        {
            ...
            m_OriginalFieldSettings = field?.Settings as AnyFieldSettings;
        ...
        {
            AnyFieldSettings fieldSettings = m_OriginalFieldSettings ?? new AnyFieldSettings();
        ...
        {
            AnyFieldSettings fieldSettings = new();
        ...
        private void UpdateFieldSettings(AnyFieldSettings fieldSettings)
        {
