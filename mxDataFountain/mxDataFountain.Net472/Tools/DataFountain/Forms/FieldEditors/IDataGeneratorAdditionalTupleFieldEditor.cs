...
namespace mxProject.Tools.DataFountain.Forms.FieldEditors
{
    ...
    /// <summary>
    /// Provides the functionality needed to edit an instance of <see cref="DataGeneratorAdditionalTupleFieldSettings"/>. 
    /// </summary>
    internal interface IDataGeneratorAdditionalTupleFieldEditor
    {
        ...
        void SetFieldSettings(DataGeneratorAdditionalTupleFieldSettingsState settings);

        /// <summary>
        /// Get the updated field.
        /// </summary>
        /// <returns>The field settings.</returns>
        DataGeneratorAdditionalTupleFieldSettingsState UpdateFieldSettings();

        /// <summary>
        /// Gets the edited field as a new instance.
        /// </summary>
        /// <returns></returns>
        DataGeneratorAdditionalTupleFieldSettings GetFieldSettingsAsNew();
